...
export abstract class ResourceProjectFlowService extends ResourceBase {  async listProjects(workspaceId: string, user: AuthUser, filters: ProjectListFilters = {}): Promise<ListPage<typeof projects.$inferSelect>> {
