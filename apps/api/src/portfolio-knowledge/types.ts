...
const SECTION_POLICIES: Record<ContextPackProjection, readonly string[]> = {
  max: ['generatedFrom', 'taskContract', 'project', 'flows', 'milestones', 'acceptedDecisions', 'verifiedArtifacts', 'repositories', 'linkedGitHub', 'taskRelations', 'dependencies', 'sourceProvenance', 'latestHandoff', 'humanReview', 'blockers', 'explicitNonGoals', 'semanticRetrieval'],
  standard: ['generatedFrom', 'taskContract', 'project', 'flows', 'milestones', 'acceptedDecisions', 'verifiedArtifacts', 'repositories', 'linkedGitHub', 'taskRelations', 'dependencies', 'latestHandoff', 'humanReview', 'blockers', 'explicitNonGoals', 'semanticRetrieval'],
  low: ['generatedFrom', 'taskContract', 'project', 'acceptedDecisions', 'repositories', 'latestHandoff', 'humanReview', 'blockers', 'explicitNonGoals'],
  review: ['generatedFrom', 'taskContract', 'project', 'acceptedDecisions', 'verifiedArtifacts', 'repositories', 'linkedGitHub', 'taskRelations', 'dependencies', 'humanReview', 'blockers', 'explicitNonGoals'],
  handoff: ['generatedFrom', 'taskContract', 'project', 'flows', 'acceptedDecisions', 'verifiedArtifacts', 'repositories', 'taskRelations', 'dependencies', 'latestHandoff', 'blockers', 'explicitNonGoals'],
};
