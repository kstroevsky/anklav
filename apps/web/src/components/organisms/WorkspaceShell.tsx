...
const nav = [{ to: 'tasks', label: 'Tasks', mark: 'T' }, { to: 'projects', label: 'Projects', mark: 'P' }, { to: 'flows', label: 'Flows', mark: 'F' }, { to: 'knowledge', label: 'Knowledge', mark: 'K' }, { to: 'reviews', label: 'Reviews', mark: 'R' }, { to: 'inbox', label: 'Inbox', mark: '●' }, { to: 'github', label: 'GitHub', mark: 'GH' }, { to: 'search', label: 'Search', mark: '⌕' }];
