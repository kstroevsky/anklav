...
export type Project = { id: string; name: string; issueKey: string; description: string; status: string; priority: string; health: string; currentFocus: string; version: number; updatedAt: string };
...
export type Task = { id: string; identifier: string; title: string; description: string; projectId: string; workflowStateId: string; priority: string; dueDate: string | null; version: number; updatedAt: string; humanReviewRequired: boolean; reviewStatus: string };
